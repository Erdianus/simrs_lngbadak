                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Buat SP3 MCU </h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">SP3</a></li>
                                <li class="breadcrumb-item active">Buat SP3 MCU</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('sp3/add/save/mcu') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <input type="hidden" name="jenis_sp3" value="mcu">
