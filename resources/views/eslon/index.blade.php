                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Eselon</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('eselon/list') }}">Eselon</a></li>
                                <li class="breadcrumb-item active">All Eselon</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('eselon/list') }}" class="btn btn-outline-gray me-2 active">
                                        ...
                                        <a href="{{ route('eselon/add/page') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <form action="{{ route('eselon/delete') }}" method="POST">
                                @csrf
